...
// Guardrails demo: commit configuration to /config/sync at the repo root
// (outside the webroot, version-controlled) instead of the gitignored
// default in the public files path. Relative paths are resolved from the
// webroot (web/), so '../config/sync' is the repo-root config/sync.
